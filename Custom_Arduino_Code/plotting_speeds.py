...
df['left_target'] = 0
df['right_target'] = 0
df.loc[df['time_s'] < 5, 'left_target'] = 50
df.loc[df['time_s'] < 5, 'right_target'] = -50
df.loc[(df['time_s'] >= 5) & (df['time_s'] < 10), 'left_target'] = 70
df.loc[(df['time_s'] >= 5) & (df['time_s'] < 10), 'right_target'] = -80
